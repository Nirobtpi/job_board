...
@section('content')
                        ...
                        <div class="row mb-5">
                            ...
                            <div class="col-12 col-sm-6 col-md-6 col-lg-3 mb-4 mb-lg-0">
                                <div class="dropdown bootstrap-select" style="width: 100%;"><select class="selectpicker"
                                        ...
                                        title="Select Region" tabindex="-98">
                            ...
                            <div class="col-12 col-sm-6 col-md-6 col-lg-3 mb-4 mb-lg-0">
                                <div class="dropdown bootstrap-select" style="width: 100%;"><select class="selectpicker"
                                        data-style="btn-white btn-lg" data-width="100%" data-live-search="true"
                                        title="Select Job Type" tabindex="-98">
                                        <option class="bs-title-option" value=""></option>
    ...
    <section class="site-section">
        <div class="container">
            <div class="row mb-5 justify-content-center">
                <div class="col-md-7 text-center">
                    <h2 class="section-title mb-2">{{ $totaljob }} Job Listed</h2>
                </div>
            </div>
        ...
        <div class="container">
            ...
            <div class="row align-items-center">
                ...
                <div class="col-6 col-lg-3 col-md-6 text-center">
                    <img src="{{ asset('') }}assets/images/logo_mailchimp.svg" alt="Image"
    ...
    <section class="bg-light pt-5 testimony-full">
        <div class="owl-carousel single-carousel owl-loaded owl-drag">
            <div class="owl-stage-outer">
                <div class="owl-stage" style="transform: translate3d(-2560px, 0px, 0px); transition: 1s; width: 7680px;">
                    <div class="owl-item cloned" style="width: 1280px;">
                        <div class="container">
                            <div class="row">
                                <div class="col-lg-6 align-self-center text-center text-lg-left">
                                    <blockquote>
                                        <p>“Soluta quasi cum delectus eum facilis recusandae nesciunt molestias accusantium
                                            libero dolores repellat id in dolorem laborum ad modi qui at quas dolorum
                                            voluptatem voluptatum repudiandae.”</p>
